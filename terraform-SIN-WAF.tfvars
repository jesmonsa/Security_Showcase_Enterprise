...
# ========================================
# CONFIGURACIÓN DE AMBIENTE VULNERABLE
# SIN PROTECCIONES DE SEGURIDAD
# ========================================
# Esta configuración muestra la aplicación SIN protecciones
# para demostrar las vulnerabilidades existentes

# Información del cliente
cliente = "vulndemo"
octetoB = "24"

# IMPORTANTE: PROTECCIONES DESHABILITADAS para esta demo
enable_waf         = false
enable_cloud_guard = false

# Base de datos (requerida) - Nombres únicos 
db_password      = "DemoWAF2025_SecureP#ss-"
db_name          = "VULNDB01"
db_pdb_name      = "VULNPDB"
db_node_hostname = "vulndb"
